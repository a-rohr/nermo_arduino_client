...
![This here is a simplified schematic setup of the electrical components. ](https://s3-us-west-2.amazonaws.com/secure.notion-static.com/8e8e4398-6564-4ba6-a540-4aedc3fc9d97/Schematic_Nermo_Embedded_ESP01s_2021-09-02.png)

This here is a simplified schematic setup of the electrical components. 

A more updated version of the electrical scheme including a custom connection board can be found here: [https://oshwlab.com/alexrohregger96/connector_board](https://oshwlab.com/alexrohregger96/connector_board). Click on "open in editor" to see the latest version of the schematics and boards.
